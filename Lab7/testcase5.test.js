...
describe("TestCase2.2", () => {
    ...
    test("Test Case 2.2: Filter Category", async () => {
        ...
        // 9. В категорії “тип” виберіть “ДБЖ безперервної дії”
        await subCategoryPage.selectFilterItem("ДБЖ безперервної дії");

       // 10. Click on first item list
       await subCategoryPage.clickOnFirstProduct();

       // 11. Verify that the characteristic states  “ДБЖ безперервної дії (Online)”
       await productDetailPage.productCharacteristicsContains("ДБЖ безперервної дії");
